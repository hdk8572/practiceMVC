					...
					<table class="table table-bordered"
						...
						<tr>
							...
							<td colspan="2"><input class="form-control"
								id="memPassword1" name="memPassword1" onkeyup="passwordCheck()"
								type="password" maxlength="20" placeholder="패스워드를 입력하세요." /></td>
						</tr>
						<tr>
							<td style="width: 110px; vertical-align: middle">비밀번호 확인</td>
							<td colspan="2"><input class="form-control"
								id="memPassword2" name="memPassword2" onkeyup="passwordCheck()"
								type="password" maxlength="20" placeholder="패스워드를 확인하세요." /></td>
						</tr>
						<tr>
							<td style="width: 110px; vertical-align: middle">사용자 이름</td>
							<td colspan="2"><input class="form-control" id="memName"
								name="memName" type="text" maxlength="20"
								placeholder="이름을 입력하세요." value="${mvo.memName}" /></td>
						</tr>
						<tr>
							<td style="width: 110px; vertical-align: middle">나이</td>
							<td colspan="2"><input class="form-control" id="memAge"
								name="memAge" type="number" maxlength="20"
						...
						<tr>
							...
							<td colspan="2"><input class="form-control" id="memEmail"
								name="memEmail" type="text" maxlength="20"
